      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
        ...
        >
          ...
          <div className="mb-6">
            ...
            <motion.h1 
              className="text-5xl md:text-7xl font-bold mt-2 bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              className="mt-4 text-3xl md:text-4xl font-semibold text-white/90"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              ...
              <div className="flex items-center">
                ...
                <div className="h-12 overflow-hidden">
                  <div>
                      ...
                      <div className="h-12 flex items-center text-purple-400 animate-slide-up delay-[400ms]">ML Enthusiast</div>
                      <div className="h-12 flex items-center text-pink-400 animate-slide-up delay-[600ms]">MERN Stack Developer</div>
                      <div className="h-12 flex items-center text-indigo-400 animate-slide-up delay-[800ms]">Dapp Developer</div>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          {/* Description */}
          <motion.p 
            className="text-lg text-gray-300 my-6 max-w-lg"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
 ...
 B.Tech Information Technology student with practical experience in MERN stack Development and Blockchain integration and Machine learning.
          ...
          >
            <button 
              ...
              className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 rounded-full text-white font-medium shadow-lg shadow-indigo-500/30 transition-all"
            >
              View Projects
            </button>
            <button 
              onClick={downloadResume} 
              className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all rounded-full text-white font-medium flex items-center"
            >
            ...
            <button 
              ...
              className="px-8 py-4 bg-transparent border border-white/30 hover:border-indigo-400 hover:text-indigo-400 transition-all rounded-full text-white font-medium"
            >
              Contact Me
            </button>
          </motion.div>
